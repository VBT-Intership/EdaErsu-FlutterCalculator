        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  box("7", Colors.greenAccent,0),
                  box("8", Colors.greenAccent,0),
                  box("9", Colors.greenAccent,0),
                  box("/", Colors.greenAccent,0),
                ],
              ),
              Row(
                children: [
                  box("4", Colors.greenAccent,0),
                  box("5", Colors.greenAccent,0),
                  box("6", Colors.greenAccent,0),
                  box("*", Colors.greenAccent,0),
                ],
              ),
              Row(
                children: [
                  box("1", Colors.greenAccent,0),
                  box("2", Colors.greenAccent,0),
                  box('3', Colors.greenAccent,0),
                  box("-", Colors.greenAccent,0),
                ],
              ),
              Row(
